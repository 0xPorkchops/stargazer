...
function WeatherDisplay() {
    ...
    const fetchWeather = async (lat: number, lon: number) => {
        try {
            const weatherResponse = await axios.get(`${import.meta.env.VITE_URL}/api/weather`, {
                params: { paramLat: lat, paramLon: lon },
            });
            const forecastResponse = await axios.get(`${import.meta.env.VITE_URL}/api/forecast`, {
                params: { paramLat: lat, paramLon: lon },
            });
