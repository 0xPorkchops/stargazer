    ...
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav className="flex flex-wrap justify-center sm:justify-end space-x-3 sm:space-x-5">
                <Button asChild variant="ghost"><Link to="/starmap" className="px-3 py-2 rounded-md text-base font-medium">Star Map</Link></Button>
                <Button asChild variant="ghost"><Link to="/weather" className="px-3 py-2 rounded-md text-base font-medium">Weather Map</Link></Button>
                ...
                <Button asChild variant="ghost"><Link to="/aurora" className="px-3 py-2 rounded-md text-base font-medium">Aurora Forecast</Link></Button>
